...
public class SeleniumUtils {
    ...
    public static final String DRIVER_PATH = "C:\\Users\\dmg01\\javapractice\\src\\DotCom\\src\\chromedriver.exe";
    ...
    public String editXpath(String xpath, String actualXpath){
        return xpath.replace("XYZZY", actualXpath);
    }


    public String insertIndexIntoXpathTwo(String xpath, int index) {
        return xpath.replace("[]", "" + index + "");
    }
